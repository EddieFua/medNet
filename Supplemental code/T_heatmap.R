...
load('/Users/fuyinghao/Documents/Mediator analysis/Revision/res/all_T.RData')
...
column_info <- tribble(
  ...
  "e_TP",   "Exposure",      "TPR",           "bar",        "palette2",  list(hjust = 0, width = 1.5),
  "e_FP",   "Exposure",      "FPR",           "bar",        "palette2",  list(hjust = 0, width = 1.5),
  "m_TP",   "Mediator",      "TPR",           "circle",        "Score",  list(hjust = 0, width = 1.5),
  "m_FP",   "Mediator",      "FPR",           "circle",        "Score",  list(hjust = 0, width = 1.5),
  "m_FDR",   "Mediator",      "FDR",           "circle",        "Score",  list(hjust = 0, width = 1.5),
)
column_groups <- tribble(
  ...
  "Mean value",     "Mediator",                           "Mediator",       "benchmark2",
)
...
ggsave('/Users/fuyinghao/Documents/Mediator analysis/Revision/figure/T_heatmap.pdf',p, device = cairo_pdf, width = p$width, height = p$height)
...
cowplot::plot_grid(p_1,p_2,p_3,ncol = 3,nrow = 1)
ggsave('/Users/fuyinghao/Documents/Mediator analysis/Revision/figure/T_comparison.png', width = 15, height = 5)
